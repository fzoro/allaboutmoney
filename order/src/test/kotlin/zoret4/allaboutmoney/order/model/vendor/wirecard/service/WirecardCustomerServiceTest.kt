    ...
    fun `customer request must be build correctly`() {
        ...
        with(argument.value) {
            assertAll("customer request preparation",
                    ...
                    { assertEquals(customer.phone.countryCode, phone.countryCode) },
                    { assertEquals(customer.phone.areaCode, phone.areaCode) },
                    { assertEquals(customer.phone.number, phone.number) },
